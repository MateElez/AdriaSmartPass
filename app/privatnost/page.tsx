...
export const metadata: Metadata = {
  title: "Politika privatnosti | Adria Security Systems",
  description: "Politika privatnosti za web stranicu Adria Security Systems."
};
    ...
    <SiteShell>
      <article className="relative z-10 mx-auto w-full min-w-0 max-w-3xl break-words px-4 pb-20 pt-16 text-slate-900 md:px-6 md:pt-24">
        ...
        <p className="mt-6 text-sm leading-relaxed text-slate-600">
          Adria Security Systems poštuje vašu privatnost i obvezuje se štititi vaše osobne podatke.
        </p>
