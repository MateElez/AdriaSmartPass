...
export const metadata: Metadata = {
  title: "Hvala na upitu | Adria Security Systems",
      ...
      <article className="relative z-10 mx-auto w-full max-w-2xl px-4 pb-24 pt-16 text-center text-slate-900 md:px-6 md:pt-24">
        <div className={cn(MARKETING_SURFACE, "px-6 py-10 md:px-10 md:py-12")}>
          ...
          <p className="mx-auto mt-6 max-w-lg text-sm leading-relaxed text-slate-600">
            Ako želite ubrzati proces, možete nam odmah poslati fotografije lokacije, tlocrte ili dodatne informacije na email.
          </p>
          <Link
            href="/"
            className="mt-10 inline-flex h-12 touch-manipulation items-center justify-center rounded-xl bg-slate-900 px-8 text-base font-semibold text-white transition hover:bg-slate-800 md:h-11"
          >
            Natrag na početnu
          </Link>
        </div>
