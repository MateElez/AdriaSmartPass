      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 md:justify-end">
        {items.map(({ href, label }) => (
          <a
            ...
            className="text-sm text-slate-400 underline-offset-4 transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
          >
            {label}
          </a>
        ))}
    ...
    <footer className="border-t border-slate-800 bg-slate-950 text-slate-300">
      <div className="mx-auto w-full max-w-7xl px-4 py-12 md:px-6">
        <div className="grid gap-10 md:grid-cols-2 md:gap-12 lg:grid-cols-[1.1fr_1fr] lg:items-start">
          <div>
            <p className="font-heading text-lg font-semibold text-white">Adria SmartPass</p>
            ...
            <div className="mt-3 flex flex-col gap-2 text-sm text-slate-400 md:items-end">
              <p>
                <a
                  ...
                  className="transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
                >
                  {CONTACT_EMAIL}
                </a>
              </p>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-slate-800/80 pt-8 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-x-6">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} Adria SmartPass
          </p>
          <nav className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-slate-500">
            <Link
              href="/privatnost"
              className="transition hover:text-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
            >
              Privatnost
            </Link>
